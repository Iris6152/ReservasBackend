...
namespace SistemadeReservas.AccesoADatos
{
    public class UsuarioDAL
    {
        ...
        public static async Task<int> EliminarAsync(Usuario pUsurio)
        {
            int result = 0;
            using (var bdContexto = new BDContexto())
            {
        ...
        internal static IQueryable<Usuario> QuerySelect(IQueryable<Usuario> pQuery, Usuario pUsuario)
        {
            ...
            {
                DateTime fechaInicial = new(pUsuario.FechaRegistro.Year, pUsuario.FechaRegistro.Month, pUsuario.FechaRegistro.Day, 0,0,0);
            ...
            return (IQueryable<Usuario>)pQuery;
